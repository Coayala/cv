...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at https://github.com/Coayala/cv/raw/main/docs/")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/Coayala/cv/raw/main/outputs/coayala_cv.pdf)")
}
```
